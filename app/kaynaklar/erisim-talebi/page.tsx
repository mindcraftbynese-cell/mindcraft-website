  ...
  return (
    <main className="relative z-10 max-w-xl mx-auto px-4 pt-40 pb-24">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <input type="hidden" name="_subject" value="Yeni İçerik Erişim Talebi" />
        ...
        <div>
          ...
          <input name="ad_soyad" required className="w-full border rounded-md px-3 py-2 text-black" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1 text-white">{c.sirket}</label>
          <input name="sirket" required className="w-full border rounded-md px-3 py-2 text-black" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1 text-white">{c.email}</label>
          <input type="email" name="email" required className="w-full border rounded-md px-3 py-2 text-black" />
        </div>
        <div>
          <label className="block text-sm font-medium mb-1 text-white">{c.pozisyon}</label>
          <input name="pozisyon" required className="w-full border rounded-md px-3 py-2 text-black" />
        </div>
